...
This recommendation system was trained based on the whole text in conjunction with those key entities.
For this, I compared a naive Bayes classifier using the bag-of-words approach and a multilayer perceptron trained on document embeddings.
