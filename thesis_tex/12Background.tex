...
\subsection{Imbalanced Class Problem}
  ...
  In the cancer example, this would mean that images of cancer are much rarer than those without cancer.
...
\subsubsection{Word2Vec}
  ...
  The synonym for this approach is called \textbf{word2vec}\index{word2vec}.
