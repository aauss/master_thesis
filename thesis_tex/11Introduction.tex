...
The Robert Koch Institute \GLS{RKI}, as a public health institute, is a crucial figure in the containment of health risks to the populace by being the primary institution for disease prevention and surveillance in Germany.
...
\subsection{INIG}
The \textbf{Informationsstelle für Internationalen Gesundheitsschutz} (\GLS{INIG}) is a young unit that is staffed by epidemiologists from different backgrounds in medicine and public health to provide international epidemiological surveillance for the RKI.
