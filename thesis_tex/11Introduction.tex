...
The Robert Koch Institute \GLS{RKI}, as a public health institute, is a key figure in the containment of any health risk.
...
Since 2001 the \textbf{Infektionsschutzgesetz} (the Protection against Infection Act) (\GLS{IfSG})is the foundation of the German surveillance system \citep{IfSG} which demands a report to the authorities after the determination of a notifiable disease (mostly based on a laboratory analysis).
