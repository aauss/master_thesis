...
According to the World Health Organization (\GLS{WHO}) \cite{WHOepi} epidemiology is a large field of studies that focus
...
The Robert Koch Institute (\GLS{RKI}) is the public health institute of Germany - It is
