...
\subsection{RASFF}
The Rapid Alert System for Food and Feed (\GLS{RASFF}) has been established by the European Union (\GLS{EU}) to efficiently share information to assure food safety. As a member of the RASFF, the RKI receives PDFs about recent events of contaminated food. Such a PDF contains several prototypical information about the incidence.
